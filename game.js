...
function preload(){
    ...
    // loading sprite image of player
...
function create(){
    ...
    background.displayWidth = W;
     ...
     background.depth = -1;// (if we write this function below ground and we want it not to overlap ground)
    ...
    this.player = this.physics.add.sprite(100,100,'dude',5);
